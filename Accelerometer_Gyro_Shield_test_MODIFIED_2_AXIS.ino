/* Joseph Picard, Brandeis Ashton-Graybiel Spatial Orientation Lab
 *  
...
//*****************************************************
{
        ...
        // in this example the gain (m) and offset (x) are setup to m=1/max and x=0, so raw data is normalized to maximum values of 1 for easier tuning across multiple scenarios. The max values can be changed in the sections above.
        // 
