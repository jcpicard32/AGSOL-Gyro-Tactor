...
//NOTE: In it's current state, temperature is not set up to work properly. More work must be done for that data to be useable.
  Serial.print(getXAccelerometerCounts());
  Serial.print("\t");
  Serial.print(getYAccelerometerCounts());
  Serial.print("\t");
  Serial.print(getZAccelerometerCounts());
  Serial.print("\t");
  Serial.print(getXGyroCounts());
  Serial.print("\t");
  Serial.print(getYGyroCounts());
  Serial.print("\t");
  Serial.print(getZGyroCounts());
  Serial.print("\t");
